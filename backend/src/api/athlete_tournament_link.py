...
async def get_all_athlete_all_tournament_links(
    ...
    return await athlete_tournament_link_service.get_all_athlete_tournament_links(offset, limit)
...
async def get_athlete_tournament_links(
    ...
    return await athlete_tournament_link_service.get_athlete_tournament_links(athlete_id)
